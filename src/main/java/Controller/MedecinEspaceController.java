...
public class MedecinEspaceController implements Initializable {
    ...
    public void switchForm(ActionEvent event) {
        try{
            ...
            stage.setScene(new Scene(root));
            stage.show();
            options.getScene().getWindow().hide();//to hide l form dyal adminEspace
        }
        catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        selectUser();//bax tji data l combo
    }
}
